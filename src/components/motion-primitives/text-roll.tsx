    ...
    <span className={className}>
      {letters.map((letter, i) => {
        return (
          <span
            key={i}
            className='relative inline-block [perspective:1000px] [transform-style:preserve-3d] [min-width:0.5em]' /* Adjusted width for responsiveness */
            aria-hidden='true'
          >
            {/* Enter side */}
            <motion.span
